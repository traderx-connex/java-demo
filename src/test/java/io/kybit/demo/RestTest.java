...
import io.kybit.api.util.KybitHttpUtil;
...
public class RestTest {
    ...
    public void testpostOrder() {
        ...
        System.out.println("result====" + KybitHttpUtil.post(uri,JSON.toJSONString(param)));
    }
    ...
    public void testpostBatchOrder() {
        ...
        System.out.println("result====" + KybitHttpUtil.post(uri,JSON.toJSONString(outParam)));
    }

    @Test
    public void getOrder() {
        String uri = "/v4/order/156201996458139136";
        System.out.println("result====" + KybitHttpUtil.get(uri, null));
    }
    ...
    public void queryOrder() {
        ...
        System.out.println("result====" + KybitHttpUtil.get(uri, param));
    }

    @Test
    public void delOrder() {
        String uri = "/v4/order/156201996458139136";
        System.out.println("result====" + KybitHttpUtil.delete(uri, null));
    }
    ...
    public void batchOrderDel() {
        ...
        System.out.println("result====" + KybitHttpUtil.deleteWithBody(uri, JSON.toJSONString(param)));
    }
    ...
    public void getToken() {
        ...
        String token = KybitHttpUtil.post(uri, null);
