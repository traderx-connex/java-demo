...
import com.cne.api.dto.future.FutureOrderCancelAllRequest;
import com.cne.api.dto.future.FutureOrderCancelRequest;
 ...
 */
public abstract class AbstractCneFutureApiClient implements CneFutureApiClient {
    ...
    abstract CneFutureApiService getService();
}
