...
import io.kybit.api.client.future.KybitFutureApiClient;
import io.kybit.api.client.future.KybitUFutureApiClientImpl;
...
public class UFutureApiClientTest {
    Gson gson = new Gson();
    KybitFutureApiClient client = new KybitUFutureApiClientImpl(null);
